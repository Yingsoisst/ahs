...
<head>
<meta charset="utf-8">
<title>ขอประเมินผลการสอนและเอกสารคำสอน (สำหรับ รองศาสตราจารย์)</title>
...
<main class="container-lg mt-2">
  ...
  <div class="row text-center mb-3">
    <div>
      ...
      <span class="h3">ขอประเมินผลการสอนและเอกสารคำสอน (สำหรับ รองศาสตราจารย์)</span><br>
      <span class="h3">บันทึกข้อความ</span>
    </div>
  </div> 

  <form action="evaluation2_pdf.php" method="post" id="fmadd" name="fmadd">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="input-group input-group-sm mb-3">
          ...
          <span class="input-group-text">ขอประเมินผลการสอนและเอกสารคำสอน</span>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="input-group input-group-sm mb-3">
          ...
          มีความประสงค์ขอประเมินการสอนและเอกสารคำสอน  โดยประเมินการสอนแบบสอนจริง 
        </div>						  
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
        <input type="hidden" name="title_head" value="ขอประเมินผลการสอนและเอกสารคำสอน (สำหรับ รองศาสตราจารย์)"  />
