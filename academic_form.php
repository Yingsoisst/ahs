...
<head>
<meta charset="utf-8">
<title>แบบคำขอรับการพิจารณากำหนดตำแหน่งทางวิชาการ (แบบ กพอ.๐๓) และผลงานทางวิชาการ</title>
...
<main class="container-lg mt-2">
  ...
  <div class="row text-center mb-3">
    <div>
      ...
      <span class="h3">แบบคำขอรับการพิจารณากำหนดตำแหน่งทางวิชาการ (แบบ กพอ.๐๓) และผลงานทางวิชาการ </span><br>
      <span class="h3">บันทึกข้อความ</span>
    </div>
  </div> 

  <form action="academic_pdf.php" method="post" id="fmadd" name="fmadd">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="input-group input-group-sm mb-3">
          ...
          <span class="input-group-text">แบบคำขอรับการพิจารณากำหนดตำแหน่งทางวิชาการ (แบบ กพอ.๐๓) และผลงานทางวิชาการ</span>
  ...
  <div class="btn-group" role="group" style="height: 30px; width: 500px;" aria-label="Basic radio toggle button group">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="input-group input-group-sm mb-3">
          <span class="input-group-text">มีความประสงค์จะขอกำหนดตำแหน่งทางวิชาการ</span>
