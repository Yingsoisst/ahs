...
<head>
<meta charset="utf-8">
<title>ขอความอนุเคราะห์ประเมินค่างานเพื่อขอกำหนดตำแหน่งเป็นระดับชำนาญการ</title>
...
<main class="container-lg mt-2">
  ...
  <div class="row text-center mb-3">
    <div>
      ...
      <span class="h3">ขอความอนุเคราะห์ประเมินค่างานเพื่อขอกำหนดตำแหน่งเป็นระดับชำนาญการ</span><br>
      <span class="h3">บันทึกข้อความ</span>
    </div>
  </div> 

  <form action="appraisal_pdf.php" method="post" id="fmadd" name="fmadd">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="input-group input-group-sm mb-3">
          ...
          <span class="input-group-text">ขอชี้แจงขอความอนุเคราะห์ประเมินค่างานเพื่อขอกำหนดตำแหน่งเป็นระดับชำนาญการในแบบแสดงหลักฐานการมีส่วนร่วมในผลงานทางวิชาการ</span>
  ...
  <div class="btn-group" role="group" style="height: 30px; width: 500px;" aria-label="Basic radio toggle button group">
    ...
    สำนักงานเลขานุการ คณะสหเวชศาสตร์ มีความประสงค์ขอรับการประเมินค่างานเพื่อขอกำหนดตำแหน่งเป็นระดับชำนาญการ  <br>
    ในการนี้  จึงขอความอนุเคราะห์ประเมินค่างานเพื่อขอกำหนดตำแหน่งจากระดับปฏิบัติการ เป็นระดับชำนาญการ พร้อมนี้ได้แนบแบบประเมินค่างานระดับชำนาญการและชำนาญการพิเศษ (ปง ๐๓) มาด้วยแล้ว รายละเอียดดังเอกสารแนบ

  
  <hr class="mt-1">
  <div class="row">
    <div class="col-md-12">
        <input type="hidden" name="title_head" value="ขอความอนุเคราะห์ประเมินค่างานเพื่อขอกำหนดตำแหน่งเป็นระดับชำนาญการ" />
